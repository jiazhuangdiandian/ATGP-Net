...
# for i in range (1):
    ...
    dataset_name = "busi"    #    "CVC-ClinicDB"       "buli"  "isic2018" "Kvasir-SEG"  "Dataset B"  "busi
    #####################################################################################
    ...
    if models_name == 'ADG_Net':     #OUNet_UOS   OUNet OUNet_O
        archs_name = ADG_Net
    ...
    def parse_args():
        ...
        parser.add_argument('--name', default='{}_{}{}_1'.format(models_name,dataset_name_replace, val_num),
